...
const Layout = ({ children }) => {
  ...
  // CLOSE MOBILE MENU + SCROLL TOP ON PAGE CHANGE
  useEffect(() => {
    setOpen(false);
  ...
  return (
    <div
      className="min-h-screen flex flex-col paper-grain"
      data-testid="app-layout"
    >
      {/* HEADER */}
      <header
          className={`fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-paper/75 border-b border-rule transition-transform duration-300 ${
      ...
      {/* MAIN CONTENT */}
          <main
              className="flex-1 relative z-0 pt-24"
        ...
        <div className="border-t border-rule">
          <div className="max-w-canvas mx-auto px-6 lg:px-12 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
            ...
            <p className="text-xs text-ink-muted">
              ...
              {config.student.fullName}. All documentation rendered in good
              faith.
            </p>
